...
def _anchor_note(
    ...
    return (
        ...
        f"  • GOOD: 'Order 841 was issued February 15, 2018 [[20180228-3066:c0000]] and the Final Rule "
        f"text specifies an effective date of [INSERT DATE 90 DAYS AFTER PUBLICATION IN THE FEDERAL "
        f"REGISTER] [[20180228-3066:c0259]]. A subsequent rehearing order confirms this 90-day window "
        f"[[20190221-3057:c0127]].'\n"
        f"  • ALSO GOOD: 'The retrieved Order 841 chunks describe the rule's substantive requirements "
